...
import Navbar from "./components/Navbar"; // ✅ must be exported with `export default`
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/client/projects/:id" element={<ProjectWorking />} />
        <Route path="/project/:id" element={<ProjectWorking />} />
